...
<div class="container">
  <h3 style="text-align: center;color: #eb9316;margin: 20px 0px;font-weight: bolder;font-size: 30px">
    <a href="${pageContext.request.contextPath}/allBookServlet"; style="text-decoration: none">WoDe书城全部商品列表</a>
  </h3>
  <div>
  ...
  <div style="margin-bottom: 20px;margin-left: 630px;width: 550px">
    <form class="form-inline" name="seekForm" action="${pageContext.request.contextPath}/seekBookServlet?type=query" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" name="classify1" class="form-control" id="exampleInputName2" >
      </div>
    ...
    <table border="1" class="table table-bordered table-hover">
      ...
      <c:forEach items="${books}" var="book" varStatus="s">
        <tr>
          ...
          <td>
            <a class="btn btn-default btn-sm" name="addCar" href="${pageContext.request.contextPath}/shopCarServlet?name=${book.name}&loginUserName=${loginUserName}">
              加入购物车
            </a>
          </td>
        </tr>
